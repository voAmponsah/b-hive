...
<body>
    ...
    <div class="auto-style1">
        ...
        <asp:Label ID="Label1" runat="server" Text="HAVE AN ACCOUNT?" Font-Size="X-Large" ForeColor="#FF0066"></asp:Label>
        <br />
        <asp:Label ID="Label2" runat="server" Text="LOGIN TO START BUYING AND SELLING" ForeColor="#FF9933"></asp:Label>
        <br />
        ...
        <br />
        <asp:HyperLink ID="fgtpass" runat="server" ForeColor="Blue" NavigateUrl="~/forgotpassword.aspx">Forgot password? Use your secutiy answer to login.</asp:HyperLink>
        <br />
        <br />
        <br />
        <br />
